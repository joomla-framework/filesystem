...
class PathTest extends FilesystemTestCase
{
    ...
    public function getResolveData()
    {
        return [
            ...
            ["/test/", "_DS_test"],
            ["C:/", "C:"],
            ["/var/www/joomla", "_DS_var_DS_www_DS_joomla"],
            ["C:/iis/www/joomla", "C:_DS_iis_DS_www_DS_joomla"],
            ["var/www/joomla", "var_DS_www_DS_joomla"],
            ["./var/www/joomla", "var_DS_www_DS_joomla"],
            ["/var/www/foo/../joomla", "_DS_var_DS_www_DS_joomla"],
            ["C:/var/www/foo/../joomla", "C:_DS_var_DS_www_DS_joomla"],
            ["/var/www/../foo/../joomla", "_DS_var_DS_joomla"],
            ["C:/var/www/..foo../joomla", "C:_DS_var_DS_www_DS_..foo.._DS_joomla"],
            ["c:/var/www/..foo../joomla", "c:_DS_var_DS_www_DS_..foo.._DS_joomla"],
            ["/var/www///joomla", "_DS_var_DS_www_DS_joomla"],
            ["/var///www///joomla", "_DS_var_DS_www_DS_joomla"],
            ["C:/var///www///joomla", "C:_DS_var_DS_www_DS_joomla"],
            ["/var/\/../www///joomla", "_DS_www_DS_joomla"],
            ["C:/var///www///joomla", "C:_DS_var_DS_www_DS_joomla"],
            ["/var\\www///joomla", "_DS_var_DS_www_DS_joomla"],
        ];
    }
